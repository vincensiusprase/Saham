...
def fetch_and_process_data():
    ...
    for category, items in TICKERS.items():
        for name, info in items.items():
            ...
            # Simpan data untuk sheet referensi mata uang
    ...
    for name, info in flat_tickers.items():
        ...
        try:
            ...
            # Flatten MultiIndex jika yfinance versi terbaru
    ...
    # ── SHEET 1: WIDE FORMAT (Perbandingan Garis/Trendline) ──
...
def upload_to_sheets():
    ...
    if ws3:
        ...
        # Menambahkan format tebal dan warna pada header (opsional agar rapi)
